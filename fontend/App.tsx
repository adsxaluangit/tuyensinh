        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <FormSection title="TẢI LÊN GIẤY TỜ XÁC THỰC">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 lg:gap-10">
              ...
              <FileUpload label="Bằng tốt nghiệp/GCN tốt nghiệp tạm thời" required placeholderImage={files.diploma || "/assets/diploma.png"} helperText="Liên thông trình độ Cao đẳng ngoài bằng tốt nghiệp THPT hoặc Giấy chứng nhận hoàn thành chương trình giáo dục phổ thông thì phải nộp bổ sung bằng tốt nghiệp Trung cấp" onFileChange={(b64) => setFiles({ ...files, diploma: b64 })} />
